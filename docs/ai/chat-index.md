...
### YOLO26x-Detection tutorials

- Date: 2026-07-02
- Role: documentation / AI memory maintenance
- Purpose: add user-facing tutorials for YOLO26x-Detection training and prediction.
- Outcome: `script/yolo26x_detection_training/tutorial.md` and `script/yolo26x_detection_prediction/tutorial.md` now document prerequisites, defaults, parameter tables, tmux usage, and criticalities.
- Active files:
  - `script/yolo26x_detection_training/tutorial.md`
  - `script/yolo26x_detection_prediction/tutorial.md`
  - `docs/ai/context.md`
