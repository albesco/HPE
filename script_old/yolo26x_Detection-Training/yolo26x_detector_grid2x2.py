...
Recommended heavy-run usage:
    ...
    tmux new-session -d -s yolo26x_detector_grid2x2 \
      'cd /home/albertosco/HPE && python script/yolo26x_detection_training/yolo26x_detector_grid2x2.py'

Dry-run / static setup check:

    python script/yolo26x_detection_training/yolo26x_detector_grid2x2.py --dry-run
"""
...
def write_report(output_root: Path, rows: list[dict[str, Any]], best: dict[str, Any] | None) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "```bash",
            "tmux new-session -d -s yolo26x_detector_grid2x2 'cd /home/albertosco/HPE && python script/yolo26x_detection_training/yolo26x_detector_grid2x2.py'",
            "```",
            "",
